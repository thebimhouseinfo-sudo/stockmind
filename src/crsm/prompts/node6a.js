...
* **Institutional Signals card**: [SIGNAL_FUNDAMENTAL] / [SIGNAL_TECHNICAL] / [SIGNAL_MACRO] / [SIGNAL_LIQUIDITY] from Node 5 \`conflict_detector\`; [SIGNAL_ALIGNMENT]; [CATALYST_NEAREST] / [CATALYST_BUCKET]; [EARNINGS_QUALITY_FLAG]; [REVERSE_DCF_CAGR] / [REVERSE_DCF_COMMENTARY].
  * Do NOT render emoji icons such as 🟢 🟡 🔴 because they can appear as dead square glyphs in exported HTML/image. Use text-safe colored dot HTML instead: positive = \`<span class="inline-block w-3 h-3 rounded-full bg-green-600" title="Tích cực"></span>\`, neutral = \`<span class="inline-block w-3 h-3 rounded-full bg-yellow-500" title="Trung lập"></span>\`, negative = \`<span class="inline-block w-3 h-3 rounded-full bg-red-600" title="Tiêu cực"></span>\`, missing = \`<span class="inline-block w-3 h-3 rounded-full bg-gray-300" title="Chưa có dữ liệu"></span>\`.
