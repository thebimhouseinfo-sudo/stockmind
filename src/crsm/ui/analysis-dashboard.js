...
function ensureStyles() {
  ...
  style.textContent = `
    ...
    .crsm-hero h2{margin:7px 0 5px;font-size:27px;color:#132341}.crsm-hero p{margin:0;color:#60718c;font-size:13px}.crsm-hero p span{margin:0 6px;color:#9ab0cb}
