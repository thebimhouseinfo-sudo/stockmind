    ...
    <div class="crsm-dashboard">
      ...
      <section class="crsm-main-grid">
        <aside class="crsm-left-rail">
          ...
          <section class="crsm-side-card"><div class="crsm-side-title">CHI PHÍ LẦN CHẠY</div>
          ...
          <section class="crsm-side-card"><div class="crsm-side-title">THÔNG TIN PHÂN TÍCH</div>
