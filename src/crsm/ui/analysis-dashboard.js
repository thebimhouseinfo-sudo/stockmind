    ...
    <div class="crsm-dashboard">
      ...
      <section class="crsm-main-grid">
        <aside class="crsm-left-rail">
          ...
          <section class="crsm-side-card crsm-cost-card"><div class="crsm-side-title">CHI PHÍ THEO NODE</div>
